  ...
  return (
    <div>
      <section style={{ paddingTop: 24, paddingBottom: 48 }}>
        <div className="container">
          <div className="mono" style={{ color: "var(--ink-500)", fontSize: 11, marginBottom: 24 }}>
            <a href="#home" style={{ color: "var(--green-700)" }}>InÃ­cio</a> / <a href="#" style={{ color: "var(--green-700)" }}>Fertilizantes</a> / NPK 04-14-08 Premium
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 48 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "80px 1fr", gap: 16 }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                {[0,1,2,3].map((i) => (
                  <button key={i} onClick={()=>setActiveImg(i)} style={{ aspectRatio: "1", borderRadius: 10, background: i===0?"var(--green-800)":i===1?"var(--green-700)":i===2?"var(--green-600)":"var(--green-500)", border: activeImg===i ? "2px solid var(--green-700)" : "1px solid var(--line)", padding: 0, position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ aspectRatio: "1", background: "var(--green-800)", borderRadius: 18, position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ position: "absolute", top: 20, right: 20, display: "flex", gap: 8 }}>
                  <button style={{ width: 44, height: 44, borderRadius: 999, background: "rgba(255,255,255,0.9)", display: "grid", placeItems: "center" }}><Icon.Heart size={18}/></button>
                  <button style={{ width: 44, height: 44, borderRadius: 999, background: "rgba(255,255,255,0.9)", display: "grid", placeItems: "center" }}><Icon.Send size={18}/></button>
                </div>
                <div style={{ position: "absolute", inset: 0, display: "grid", placeItems: "center", color: "rgba(255,255,255,0.6)", fontFamily: "var(--mono)", fontSize: 12, letterSpacing: "0.12em" }}>
                  [ FOTO PRODUTO â€” SACO 50KG ]
                </div>
                <div style={{ position: "absolute", bottom: 16, left: 16, right: 16, display: "flex", justifyContent: "center", gap: 6 }}>
                  {[0,1,2,3].map((i) => <span key={i} style={{ width: i===activeImg?24:6, height: 6, borderRadius: 999, background: i===activeImg ? "var(--cream-100)" : "rgba(255,255,255,0.4)" }}/>)}
                </div>
              </div>
            </div>
            ...
            {/* INFO */}
            <div>
              <div className="mono" style={{ color: "var(--ink-500)" }}>Santos Mix â€¢ CÃ³d. 04-14-08-PRM</div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginTop: 12, fontSize: 14, color: "var(--ink-700)" }}>
                ...
                <span style={{ color: "var(--ink-500)" }}>Â· 142 avaliaÃ§Ãµes Â· 1.2k vendidos</span>
              </div>
              ...
              <div style={{ marginTop: 24, padding: 24, borderRadius: 14, background: "var(--cream-100)" }}>
                ...
                <div style={{ fontSize: 13, color: "var(--ink-700)", marginTop: 4 }}>por saco de 50kg â€¢ {brl(p.price/50)} o kg</div>
                <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 6, fontSize: 14 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}><Icon.Pix size={16} color="var(--green-700)"/> <span className="bold" style={{ color: "var(--green-800)" }}>{brl(p.price * 0.95)}</span> Ã  vista no Pix (5% off)</div>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}><Icon.Barcode size={16} color="var(--ink-700)"/> ou boleto agrÃ­cola â€” fatura na safra</div>
                </div>
              </div>
              ...
              <div style={{ marginTop: 24 }}>
                ...
                <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                  ...
                  <span style={{ fontSize: 13, color: "var(--ink-500)" }}>= {qty * 50}kg â€¢ Total {brl(p.price * qty)}</span>
                </div>
                <div style={{ marginTop: 8, fontSize: 12, color: "var(--green-700)" }}>âœ“ 240 sacos disponÃ­veis em estoque</div>
              </div>
              ...
              <div style={{ marginTop: 24, padding: 20, border: "1.5px solid var(--line-strong)", borderRadius: 14 }}>
                <div className="display" style={{ fontSize: 14, fontWeight: 600, marginBottom: 12, display: "flex", alignItems: "center", gap: 8 }}>
                  <Icon.Truck size={18} color="var(--green-700)"/> Calcular frete pra sua roÃ§a
                </div>
                ...
                <div style={{ marginTop: 12, display: "flex", flexDirection: "column", gap: 8 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 14px", background: "var(--green-50)", borderRadius: 10, border: "1px solid var(--green-100)" }}>
                    <div>
                      <div style={{ fontSize: 14, fontWeight: 500, color: "var(--green-800)" }}>âœ“ Frete grÃ¡tis na lavoura</div>
                      <div style={{ fontSize: 12, color: "var(--ink-500)" }}>Entrega entre 02 e 04 mai (terÃ§a a quinta)</div>
                    </div>
                    <div className="bold" style={{ color: "var(--green-800)" }}>GRÃTIS</div>
                  </div>
              ...
              <div style={{ marginTop: 16, display: "flex", gap: 16, alignItems: "center", padding: "12px 0", fontSize: 12, color: "var(--ink-500)" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}><Icon.Whatsapp size={14} color="var(--green-700)"/> Suporte agrÃ´nomo</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ paddingTop: 24 }}>
        <div className="container">
          <div className="tabs">
            {[["descricao","DescriÃ§Ã£o"],["especificacoes","EspecificaÃ§Ãµes tÃ©cnicas"],["aplicacao","Modo de aplicaÃ§Ã£o"],["avaliacoes","AvaliaÃ§Ãµes (142)"]].map(([k,l])=>(
          ...
          <div style={{ padding: "32px 0", display: "grid", gridTemplateColumns: tab==="avaliacoes" ? "1fr 1fr" : "1.5fr 1fr", gap: 48 }}>
            {tab === "descricao" && (
              <>
                <div>
                  ...
                  <h3 style={{ marginTop: 8, fontSize: 28 }}>NutriÃ§Ã£o balanceada pra sua prÃ³xima colheita</h3>
                  <p style={{ marginTop: 16, fontSize: 16, lineHeight: 1.7, color: "var(--ink-700)" }}>
                    O NPK 04-14-08 Premium da Santos Ã© a fÃ³rmula favorita de quem planta soja, milho e cafÃ© no Sul de Minas. Com nitrogÃªnio de liberaÃ§Ã£o controlada, fÃ³sforo solÃºvel em Ã¡cido cÃ­trico e potÃ¡ssio em forma cloretada, Ã© a base certa pra um plantio que rende.
                  </p>
                  <p style={{ marginTop: 16, fontSize: 16, lineHeight: 1.7, color: "var(--ink-700)" }}>
                    Granulometria uniforme pra distribuiÃ§Ã£o precisa â€” nÃ£o entope plantadeira, nÃ£o empedra no estoque. Pra cada saco, a garantia Santos: se nÃ£o rendeu, a gente troca.
                  </p>
                  <div style={{ marginTop: 24, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                    {[
                      {t: "Pra cultura", v: "Soja, milho, cafÃ©, hortaliÃ§as"},
                ...
                <aside style={{ background: "var(--green-900)", color: "var(--cream-100)", borderRadius: 18, padding: 32 }}>
                  <div className="mono" style={{ color: "var(--orange-500)" }}>AnÃ¡lise tÃ©cnica</div>
                  <h4 style={{ marginTop: 12, fontSize: 24, color: "var(--cream-100)" }}>Garantias da fÃ³rmula</h4>
                  <div style={{ marginTop: 24, display: "flex", flexDirection: "column", gap: 16 }}>
                    {[
                      {l: "NitrogÃªnio (N)", v: "4%", color: "var(--orange-500)"},
                      {l: "FÃ³sforo (Pâ‚‚Oâ‚…)", v: "14%", color: "var(--yellow-300)"},
                      {l: "PotÃ¡ssio (Kâ‚‚O)", v: "8%", color: "var(--green-500)"},
                      {l: "Enxofre (S)", v: "5%", color: "rgba(255,255,255,0.6)"},
                    ].map((it,i)=>(
                      <div key={i}>
                  ...
                  <button className="btn btn-block" style={{ marginTop: 24, background: "var(--cream-100)", color: "var(--green-900)" }}>Baixar ficha tÃ©cnica (PDF)</button>
                </aside>
              </>
            )}
            {tab === "especificacoes" && (
              <div style={{ gridColumn: "1 / -1" }}>
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
                  {[
                    ["FormulaÃ§Ã£o", "NPK 04-14-08 + 5% S"],
                    ["Granulometria", "2,8 a 4,0 mm"],
                    ["Densidade aparente", "1,02 g/cmÂ³"],
                    ["Solubilidade do fÃ³sforo", "Ãcido cÃ­trico 2%"],
                    ["Forma fÃ­sica", "Granulado misturado"],
            ...
            {tab === "aplicacao" && (
              <div style={{ gridColumn: "1 / -1", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
                {[
                  {n: "01", t: "AnÃ¡lise do solo", b: "Antes de aplicar, faÃ§a anÃ¡lise do solo. Mande pra gente â€” fazemos a recomendaÃ§Ã£o certa pra sua Ã¡rea."},
                  {n: "02", t: "AplicaÃ§Ã£o no plantio", b: "Distribua 300 a 400 kg/ha em sulco no momento do plantio. Plantadeira regulada â€” granulometria uniforme nÃ£o entope."},
                  {n: "03", t: "Cobertura", b: "30 a 45 dias apÃ³s plantio, faÃ§a cobertura com ureia ou foliar Santos. Combo plantio fecha o ciclo."},
                ].map((s,i)=>(
            ...
            {tab === "avaliacoes" && (
              <>
                <div>
                  <div style={{ display: "flex", gap: 32, alignItems: "center", padding: 24, background: "var(--cream-100)", borderRadius: 14 }}>
                    <div style={{ textAlign: "center" }}>
                      ...
                      <div style={{ fontSize: 12, color: "var(--ink-500)", marginTop: 4 }}>142 avaliaÃ§Ãµes</div>
                    </div>
                    <div style={{ flex: 1 }}>
                      {[5,4,3,2,1].map(s => (
                        <div key={s} style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                          <span style={{ fontSize: 12, width: 14 }}>{s}â˜…</span>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  {[
                    {n: "Aldemir T.", c: "Pouso Alegre/MG", r: 5, t: "Comprei pra 12 hectares de cafÃ©, rendeu demais. Plantadeira nÃ£o entupiu uma vez. Recomendo.", d: "hÃ¡ 3 dias"},
                    {n: "SebastiÃ£o R.", c: "ItajubÃ¡/MG", r: 5, t: "TÃ´ comprando da Santos hÃ¡ 8 anos. Esse NPK Ã© o melhor pra minha lavoura de soja. Frete chegou na quinta como combinado.", d: "hÃ¡ 1 semana"},
                  ].map((rev,i)=>(
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                          ...
                          <div>
                            ...
                            <div style={{ fontSize: 12, color: "var(--ink-500)" }}>{rev.c} Â· {rev.d}</div>
                          </div>
                        </div>
        ...
        <div className="container">
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 24 }}>
            <div>
              ...
              <h2>Quem comprou esse, levou tambÃ©m</h2>
            </div>
          </div>
